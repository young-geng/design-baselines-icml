...
If these applications interest you, consider using our benchmark: design-bench, which you may install to python and automatically download benchmark data using `pip install design-bench==2.0.12`.
...
COMS                          |  0.439 ± 0.033 |  0.944 ± 0.016 |      0.949 ± 0.015 |     2.056 ± 0.314
...
COMS                          |  0.864 ± 0.000 |  0.945 ± 0.033 |  0.699 ± 0.011
